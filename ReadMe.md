...
Go users can use the pure-Go module without installing the shared library:
...
- **Cross-Language Consistency**: Identical behavior in 32 languages from the
  same YAMLStar core
...
- Pure-Go module generated by Gloat/Glojure
...
YAMLStar provides bindings for multiple programming languages from the same
core implementation. Most native bindings use the Gloat/Glojure shared library
(`libyamlstar.so`); Go uses generated Go code directly.
