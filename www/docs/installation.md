...
```bash
brew install yaml/yamlstar/yamlstar@0.1.10
brew install yaml/yamlstar/libyamlstar@0.1.10
```
...
```bash
tar -xf yamlstar-0.1.10-linux-x64.tar.xz
cd yamlstar-0.1.10-linux-x64
