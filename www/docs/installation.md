...
```bash
brew install yaml/yamlstar/yamlstar@0.1.7
brew install yaml/yamlstar/libyamlstar@0.1.7
```
...
```bash
tar -xf yamlstar-0.1.7-linux-x64.tar.xz
cd yamlstar-0.1.7-linux-x64
