...
**Install:**
```clojure
{:deps {org.yamlstar/yamlstar {:mvn/version "0.1.19"}}}
```
...
Pure-Go binding generated by Gloat and Glojure.
...
data, _ := yamlstar.Load("key: value")
fmt.Println(data)
```
...
**Install:**
```scala
libraryDependencies += "com.yaml" % "scala-yamlstar" % "0.1.19"
```
...
- **Node.js**: `ys.load(yaml_string)`
- **Go**: `yamlstar.Load(yaml_string)`
...
- **Go**: `yamlstar.LoadAll(yaml_string)`
...
- Requires Go 1.24+
- Pure Go; cgo and `libyamlstar` are not required
