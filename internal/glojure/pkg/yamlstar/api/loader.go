...
func LoadNS() {
	...
	// dump
	{
		...
		var_yamlstar_DOT_api_dump.SetMetaLazyMacro(func() lang.IPersistentMap {
			return lang.NewMapUniqueKeys(kw_file, "yamlstar/api.clj", kw_line, int(75), kw_column, int(7), kw_end_DASH_line, int(75), kw_end_DASH_column, int(10), kw_arglists, lang.NewList(lang.NewVector(sym_value)), kw_doc, "Dump a supported native value to a YAML string.", kw_ns, lang.FindOrCreateNamespace(sym_yamlstar_DOT_api))
		}, false)
	}
	// load
	{
	...
	// version
	{
		...
		var_yamlstar_DOT_api_version.SetMetaLazyMacro(func() lang.IPersistentMap {
			return lang.NewMapUniqueKeys(kw_file, "yamlstar/api.clj", kw_line, int(92), kw_column, int(7), kw_end_DASH_line, int(92), kw_end_DASH_column, int(13), kw_arglists, lang.NewList(lang.NewVector()), kw_doc, "Return the YAMLStar version string", kw_ns, lang.FindOrCreateNamespace(sym_yamlstar_DOT_api))
		}, false)
	}
	// dump-all
	{
		...
		var_yamlstar_DOT_api_dump_DASH_all.SetMetaLazyMacro(func() lang.IPersistentMap {
			return lang.NewMapUniqueKeys(kw_file, "yamlstar/api.clj", kw_line, int(84), kw_column, int(7), kw_end_DASH_line, int(84), kw_end_DASH_column, int(14), kw_arglists, lang.NewList(lang.NewVector(sym_values)), kw_doc, "Dump a sequence of supported native values to a YAML stream.", kw_ns, lang.FindOrCreateNamespace(sym_yamlstar_DOT_api))
		}, false)
	}
}
