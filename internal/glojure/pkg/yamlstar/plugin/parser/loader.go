...
var aotKeywordMapShape0 = lang.NewKeywordMapShape("name")
...
var aotKeywordMapShape1 = lang.NewKeywordMapShape("parser")
...
func LoadNS() {
	...
	// name
	{
		...
		tmp1 = lang.FnFunc1(func(p0 any) any {
			v2 := p0
			_ = v2
			tmp3 := aotKeywordMapNew0(v2)
			tmp4 := aotKeywordMapNew1(tmp3)
			return tmp4
		})
		aotDirectFn1 = tmp1
